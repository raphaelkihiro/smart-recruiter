...
export default function InvitePage() {
  ...
  async function fetchData() {
    ...
    try {
      const [assessmentsRes, invitesRes] = await Promise.all([
      ...
      const [assessmentsData, invitesData] = await Promise.all([
        assessmentsRes.json(),
        invitesRes.json(),
      ]);
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#12283f] text-white pt-20">
  ...
  return (
    <div className="min-h-screen bg-[#12283f] text-white pt-10 pb-10">
